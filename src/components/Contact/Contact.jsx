...
export const Contact = ({sectionRef3}) =>{
    ...
    const openModalMessageSuccess = () =>{
        const modal = document.querySelector(".modal-message-success")

        modal.showModal()
    } 

    const closeModalMessageSuccess = () =>{
        const modal = document.querySelector(".modal-message-success")
    ...
    return(
        <>
            <dialog className="modal-message-success">
                <p>E-mail enviado com sucesso</p>
                <button onClick={() => closeModalMessageSuccess()}>Fechar</button>
            </dialog>
